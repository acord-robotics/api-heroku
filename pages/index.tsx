...
const Page = () => {
  ...
  return (
    <>
      <Heading user={{ name: 'Liam Arbuckle', role: 'Developer', github: 'Gizmotronn' }} />
      <div className="page__wrapper">
        <div className="page__content">
          <div className="projects">
            <Project projectId="GemReactPortal" repo="acord-robotics/api-heroku" createdAt="♊️ 🛰 GSCA-4" />
            <Project projectId="jsxchat" repo="gizmotronn/gem-vercel" createdAt="💬 GSCA-7" />
            <Project projectId="Gem Jekyll Demo" repo="acord-robotics/gem-jekyll-demo" createdAt="♊️ 🛰 GSCA" />
            <NextLink href="https://vercel.com/dashboard/projects" passHref>
          ...
          <div className="recent-activity">
            ...
            <NextLink href="https://vercel.com/dashboard/activity" passHref>
              <Link className="view-all" color underline>
                View All Activity
              </Link>
            </NextLink>
