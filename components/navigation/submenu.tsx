        ...
        <div className={`sub-menu ${sticky ? 'sub-menu_sticky' : ''}`}>
          <div className="sub-menu__inner">
            <Tabs value={router.asPath} onChange={(route) => router.push(route)}>
              ...
              <Tabs.Item label="Projects" value="https://vercel.com/dashboard/projects" />
              <Tabs.Item label="Integrations" value="https://vercel.com/dashboard/integrations" />
              <Tabs.Item label="Activity" value="https://vercel.com/dashboard/activity" />
              <Tabs.Item label="Domains" value="https://vercel.com/dashboard/domains" />
              <Tabs.Item label="Usage" value="https://vercel.com/dashboard/usage" />
              <Tabs.Item label="Settings" value="https://vercel.com/dashboard/settings" />
            </Tabs>
          </div>
        </div>
      </nav>
